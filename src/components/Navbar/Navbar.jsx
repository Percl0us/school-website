...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-full">
        ...
        <Link to="/" className="flex items-center gap-3 shrink-0 group">
          <div className="relative">
            <img src={logo} alt="Logo" className="h-10 md:h-12 w-auto rounded-lg transition-transform group-hover:scale-105" />
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-bold tracking-[0.2em] text-gray-500 uppercase">School • Kalkha</span>
          </div>
        </Link>
              ...
              <Link
                ...
                className={`px-4 py-2 text-sm font-bold transition-all duration-200 rounded-xl relative group ${
                  isActive 
                    ...
                    : link.highlight ? "text-blue-600 hover:text-blue-700" : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                }`}
              >
                {link.name}
                {isActive && (
        ...
        <button
          ...
          className="xl:hidden p-2.5 rounded-xl bg-gray-50 text-gray-900 hover:bg-gray-100 transition-colors"
        >
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`fixed inset-0 top-[64px] bg-white z-[90] xl:hidden transition-transform duration-500 ease-in-out ${
        ...
        <div className="p-6 flex flex-col h-full">
          <div className="space-y-2 overflow-y-auto flex-1">
            {navLinks.map((link) => (
              ...
              >
                <span className="font-bold text-lg text-gray-800 group-hover:text-blue-700">{link.name}</span>
